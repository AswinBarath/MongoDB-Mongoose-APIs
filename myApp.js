...
const createAndSavePerson = (done) => {
	let aswin = new Person({
			name: "Aswin",
			age: 19,
			favouriteFoods: ["Dosa", "Dal"]
	});

	aswin.save(function(err, data) {
...
arrayOfPeople = (
	[{ name: "Barath", age: 19, favouriteFoods: ["Dosa", "Dal"]
	}, 
	{ name: "Sriram", age: 13, favouriteFoods: ["Naan", "Paneer"]
	}])
